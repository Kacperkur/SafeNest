                        ...
                        children: [
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'PROFILE_BASE_Column_j14bfgau_ON_TAP');
                                        logFirebaseEvent(
                                            'Column_navigate_back');
                                        context.safePop();
                                      },
                                      child: Column(
                                        mainAxisSize: MainAxisSize.max,
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_BASE_Row_79t7n8zl_ON_TAP');
                                    logFirebaseEvent('Row_navigate_to');

                                    context.pushNamed('SavedListingPage');
                                  },
                                  child: Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PROFILE_BASE_contentView_1_ON_TAP');
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_BASE_Row_p7k5ssqj_ON_TAP');
                                    logFirebaseEvent('Row_navigate_to');
